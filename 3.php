    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                $("#btn1").click(function () {
                    $("#set").append("<div> <br/> <hr/> <span>Business Goals</span> <textarea name='expt[]'></textarea> <br/> <br/> <span>Shared Value</span> <textarea name='expt[]'></textarea> <br/> <br/> <span>KPI</span> <textarea name='expt[]'></textarea> <br/> <br/>  <span>Target</span> <textarea name='expt[]'></textarea> </div>.");
                });
            });
        </script>
    ...
    <body>
        <div>
            <div class="form" id="form">
                <form action="backEnd/expectations.php" method="POST">
                    <center>
                        <h1>Audience Expectations</h1>
                    </center>
                    <br/>
                    <div style = "width: 95%; margin: auto;" id = "set">
                        <?php
                        foreach ($_SESSION["aTr"] as $key => $value) {
                            echo "
                                <div style = ''>
                         <h5>Audience No: " . ++$key . ", " . $value . "</h5>
                        <span>Business Goals</span>
                        <textarea name='expt[]'></textarea>
                        ...
                        <!--                    <div style="width: 100%; border-bottom: solid 1px;" id="set">
                    ...
                    <div style="width: 42%; margin-left: 62%;">
                        <button type="button" id="btn1" class="bt2">Add</button>
